            ...
            if n_sel <= 5:
                ...
                for mn, cat in zip(m_names, cats):
                    hdr += (
                        ...
                        f'<div style="font-weight:700;font-size:{hdr_fs}px;color:#1A1A2E;'
                        f'line-height:1.3;word-break:break-word;">{mn}</div>'
                        f'<div style="font-size:{lbl_fs}px;color:#6B7280;">{cat}</div></td>'
                    )
                tbl_rows = ""
                for fa, mn, fa_cat in zip(matched_funds, m_names, cats):
                    ...
                    for fb in matched_funds:
                        if fa == fb:
                            cells += (
                                f'<td style="padding:{pad}px;"><div style="background:#F3F4F6;'
        ...
        with col_top:
            ...
            def _xr_ch_row(stock, alloc, sector_val):
                ...
                if extra_funds > 0:
                    ...
                    if extra_holding > 0:
                        dots += (
                            f'<span style="font-size:0.6rem;color:#6B7280;margin-left:1px;">'
